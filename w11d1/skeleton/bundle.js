...
var GiphysIndex = function GiphysIndex(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, giphys.map(function (giphy) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_giphys_index_item__WEBPACK_IMPORTED_MODULE_1__["default"], {
      giphy: giphy,
      key: giphy.id
    });
  }));
...
var GiphysSearch = /*#__PURE__*/function (_Component) {
  _inherits(GiphysSearch, _Component);

  var _super = _createSuper(GiphysSearch);
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function handleSubmit(e) {
      e.preventDefault();
      var searchedVal = this.state.searchTerm.split(" ").join("+");
    ...
    value: function render() {
      ...
      }, " Submit ")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_giphys_index__WEBPACK_IMPORTED_MODULE_1__["default"], {
        giphys: giphys
      }));
    }
  }]);
...
var Root = function Root(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_redux__WEBPACK_IMPORTED_MODULE_1__["Provider"], {
    store: store
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_giphys_search_container__WEBPACK_IMPORTED_MODULE_2__["default"], null));
};
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var root = document.getElementById('root'); // window.store = store
...
var GIPHY_KEY = process.env.GIPHY_API_KEY;
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    method: 'GET',
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=").concat(GIPHY_KEY, "&limit=2")
  });
};
