...
describe Dessert do
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["sugar", "flour", "egg", "butter", "vanilla extract"]
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      allow(chef).to receive(:titleize).and_return("Chef Niko the Great Baker")
      expect(cake.serve).to eq("Chef Niko the Great Baker has made 20 cakes!")
    end
  end
